...
/*  -- SuperLU auxiliary routine (version 5.0) --   
    ...
    QMACH returns float128 precision machine parameters.   

    Arguments   
    =========   

    QMACH   (input) CHARACTER*1   
...
*/
    ...
    __float128 sfmin, small, rmach;

    if (strncmp(cmach, "E", 1)==0) {
	rmach = FLT128_EPSILON * 0.5;
