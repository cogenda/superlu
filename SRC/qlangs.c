 ...
 * November 15, 1997
 *
 * Modified from lapack routine QLANGE 
 * </pre>
 */
/*
 * File name:	qlangs.c
 * History:     Modified from lapack routine QLANGE
 */
#include <math.h>
#include "slu_qdefs.h"
 ...
 *   =======   
 *
 *   QLANGS returns the value of the one norm, or the Frobenius norm, or 
...
quadreal qlangs(char *norm, SuperMatrix *A)
{
	...
	/* Find normI(A). */
	if ( !(rwork = (quadreal *) SUPERLU_MALLOC(A->nrow * sizeof(quadreal))) )
