...
void qlsolve ( int ldm, int ncol, quadreal *M, quadreal *rhs )
{
    int k;
    quadreal x0, x1, x2, x3, x4, x5, x6, x7;
    quadreal *M0;
    quadreal *Mki0, *Mki1, *Mki2, *Mki3, *Mki4, *Mki5, *Mki6, *Mki7;
 ...
 */
void
qusolve ( ldm, ncol, M, rhs )
int ldm;	/* in */
int ncol;	/* in */
quadreal *M;	/* in */
quadreal *rhs;	/* modified */
{
    quadreal xj;
    int jcol, j, irow;
 ...
 */
void qmatvec ( ldm, nrow, ncol, M, vec, Mxvec )
...
quadreal *M;	/* in */
quadreal *vec;	/* in */
quadreal *Mxvec;	/* in/out */

{
    quadreal vi0, vi1, vi2, vi3, vi4, vi5, vi6, vi7;
    quadreal *M0;
    quadreal *Mki0, *Mki1, *Mki2, *Mki3, *Mki4, *Mki5, *Mki6, *Mki7;
    register int firstcol = 0;
    int k;
