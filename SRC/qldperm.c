 ...
 * =======
 *
 *   QLDPERM finds a row permutation so that the matrix has large
 ...
 *
 * nzval  (input) quadreal*, of size nnz
...
int
qldperm(int_t job, int_t n, int_t nnz, int_t colptr[], int_t adjncy[],
	quadreal nzval[], int_t *perm, quadreal u[], quadreal v[])
{ 
    int_t i, liw, ldw, num;
