...
ilu_qpivotL(
	const int  jcol,     /* in */
	const quadreal u,      /* in - diagonal pivoting threshold */
	...
	quadreal   fill_tol, /* in - fill tolerance of current column
			      * used for a singular column */
	milu_t	   milu,     /* in */
	quadreal	   drop_sum, /* in - computed in ilu_scopy_to_ucol()
                                (MILU only) */
